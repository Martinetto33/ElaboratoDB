...
namespace TestClashOfClansDatabase
{
    ...
    public class TestModel
    {
        ...
        private static Defense CreateDefense() => new(1, "Cannon", 1, 100, 20.0, 1, 10);

        [TestMethod]
        public void TestEnumToString()
        {
            Assert.AreEqual("Special", Enums.BuildingType.Special.ToString());
        }
        ...
        public async Task TestMaxLevel()
        {
            ...
            var building = new Defense(12, "Cannon", bLevel, bHealth, bDamagePerSecond, targetsNumber, range);
            await builder.UpgradeBuilding(building);
